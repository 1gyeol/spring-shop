     	...
     	<div class="col-md-12">
            ...
            비밀번호 -->
             ...
             <div class="form-group row" style="display: flex; align-items: center;">
               ...
               <div class="col-sm-6">
                <span id="mb_name" name="mb_name">${memberVO.mb_name}</span>
               </div>
             </div>
             <!-- 이름 -->
             <!-- 휴대폰 번호 -->
             <div class="form-group row" style="display: flex; align-items: center;">
              ...
              <div class="col-sm-6">
                <span id="mb_phone" name="mb_phone">${memberVO.mb_phone}</span>                
              </div>
             </div>
             <!-- 휴대폰 번호 -->
             ...
             <div class="form-group row" style="display: flex; align-items: center;">
               ...
               <div class="col-sm-6">
                <span id="mb_email" name="mb_email">${memberVO.mb_email}</span>
               </div>
             </div>
             <!-- 이메일 주소 -->
             ...
             <div class="form-group row" style="display: flex; align-items: center;">
               ...
               <div class="col-sm-6">
                <span id="mb_birth" name="mb_birth">${memberVO.mb_birth}</span>
               </div>
             </div>
             <!-- 생년월일 --> 
             ...
             <div class="form-group row" style="display: flex; align-items: center;">
              ...
              <div class="col-sm-6">
                <span id="mb_zipcode" name="mb_zipcode">${memberVO.mb_zipcode}</span> <br>
                <span id="mb_addr" name="mb_addr">${memberVO.mb_addr }</span>
                <span id="mb_deaddr" name="mb_deaddr">${memberVO.mb_deaddr}</span> </div>
            </div>
            <!-- 주소 -->  
            
            <!-- 가입일 -->
             <div class="form-group row" style="display: flex; align-items: center;">
              <label for="mb_birth" class="col-sm-2 col-form-label">가입일</label>
              <div class="col-sm-6">
                <fmt:formatDate value="${memberVO.mb_regdate}" pattern="yyyy-MM-dd HH:mm"/>                
              </div>
            </div>
            <!-- 가입일 --> 
            ...
            <!-- 탈퇴일 -->
             <div class="form-group row" style="display: flex; align-items: center;">
              <label for="mb_birth" class="col-sm-2 col-form-label">탈퇴일</label>
              <div class="col-sm-6">
                <fmt:formatDate value="${memberVO.mb_deletedate}" pattern="yyyy-MM-dd HH:mm"/>   
              </div>
            </div>
            <!-- 탈퇴일 --> 
            ...
            <div class="box-footer">
              ...
              <div class="form-group" style=" display:flex; justify-content: space-between;">
                <div>
                 <button type="button" class="btn btn-dark" id="btnCancel" onclick="history.go(-1)">뒤로가기</button>
                </div>			
             </div>
            </div>
     			</form>
