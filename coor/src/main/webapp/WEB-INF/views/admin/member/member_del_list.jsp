...
<head>
  ...
  <title>관리자페이지 | 회원 관리 | 탈퇴 회원 목록</title>
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <fmt:formatDate value="${memberList.mb_deletedate }" pattern="yyyy-MM-dd HH:mm"/>
                  </td>
                  <td>
                  	<button type="button" name="btn_memberEdit" data-mb_id="${memberList.mb_id }" class="btn">상세</button>
                  </td>
                </tr>
                </c:forEach>
  ...
  $(document).ready(function() {
    ...
    // 페이지 번호, 이전, 다음 클릭시 actionForm 태그가 전송으로 사용된다.(중요)
      ...
      $("button[name='btn_memberEdit']").on("click", function() {
        ...
        actionForm.attr("action", "/admin/member/member_del_detail");
        actionForm.submit();
