                ...
                <div class="form-group row">
                  ...
                  <form id="searchForm" action="/admin/product/pro_list" method="get">
                    <select name="type">
                      ...
                      <option value="N" <c:out value="${pageMaker.cri.type eq 'C'? 'selected':'' }" />>내용</option>
                    </select>
                  ...
                  <div class="col-md-2">
                    <button type="button" id="btn_checkedModify" class="btn">선택상품수정</button>
                    <button type="button" id="btn_checkedDelete" class="btn btn-danger">선택상품삭제</button>
                  </div>
                </div>
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a class="move" href="${productVO.pro_num }"><img src="/admin/product/displayImage?folderName=${productVO.pro_up_folder }&fileName=s_${productVO.pro_up_img}" /></a>
                  ...
                  <td>
                  	<button type="button" name="btn_productEdit" data-pro_num="${productVO.pro_num }" class="btn">상세</button>
					<button type="button" name="btn_productDel" data-pro_num="${productVO.pro_num }" class="btn btn-danger">삭제</button>
				  </td>
                </tr>
                </c:forEach>
    ...
    // 페이지 번호, 이전, 다음 클릭시 actionForm 태그가 전송으로 사용된다.(중요)
      ...
      $("#btn_checkedModify").on("click", function() {
        ...
        $("input[name='check']:checked").each(function() {
          ...
          pro_show_arr.push($(this).parent().parent().find("select[name='pro_show']").val());
        });
        ...
        */
        ...
        $.ajax({
          ...
          type:'post',
          data: {pro_num_arr: pro_num_arr, pro_price_arr:pro_price_arr, pro_buy_arr:pro_buy_arr, pro_show_arr:pro_show_arr},
          dataType: 'text',
