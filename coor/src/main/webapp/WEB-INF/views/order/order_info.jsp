      ...
      <div class="col-md-12">
          <div class="box">
            ...
            <div class="row border-top pt-3">
              ...
              <div class="row pt-3">
                <div class="col-md-2">
                  <label for="mb_email">전자우편</label>
                </div>
                <div class="col-md-10">
                  <input type="hidden" id="order_productName" value="${order_productName}">
                  <input type="text" class="form-control" name="d_mb_email" id="d_mb_email" value="${memberVO.mb_email }">
                </div>
              </div>
              <div class="row pt-3">
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="d_mb_phone" id="d_mb_phone" value="${memberVO.mb_phone }">
                </div>
              </div>
              <h4 class="mb-3 mt-3">배송정보 <span><input type="checkbox" id="cb" onclick="Copy();">위 정보와 같음</span></h4>
              <div class="row border-top pt-3">
                <div class="col-md-2">
              ...
              <div class="row pt-3">
                <div class="col-md-2">
                  <label for="mb_id">주소</label>
                </div>
                <div class="col-md-10">
                  <input type="text" class="form-control" name="ord_zipcode" id="sample2_postcode">
                  <button type="button" onclick="sample2_execDaumPostcode()" class="btn btn-dark">우편번호 찾기</button>
                  <input type="text" class="form-control" name="ord_addr" id="sample2_address" placeholder="서울특별시 강남구">
                  <input type="text" class="form-control" name="ord_deaddr" id="sample2_detailAddress" placeholder="상세주소를 입력해주세요.">
              ...
              <div class="mb-4 text-center">
                ...
                <button name="btn_buy" data-paytype="bank" class="btn btn-dark" id="btn_order" type="button">무통장 결제하기</button>
              ...
              <div class="mb-4 text-center">
                <input type="hidden" name="ord_price" id="ord_price" value="${cart_tot_price }">
                <button name="btn_buy" class="btn btn-dark" id="btn_order" type="button">결제하기</button>
              </div>
          </div>
          </div>
        </div>
     <div class="row">
        <div class="col-md-12">
          ...
          <table class="table table-bordered">
            ...
            <tr>
              <td>
                <img src="/cart/displayImage?folderName=${cartListDTO.pro_up_folder }&fileName=s_${cartListDTO.pro_up_img}" />
                <c:out value="${cartListDTO.pro_name }" ></c:out>
                <input type="hidden" name="${cartListDTO.pro_num }">
              </td>
              <td>
              ...
              <td>
                <fmt:formatNumber type="currency" pattern="₩#,###" value="${cartListDTO.unitprice }"/>
              </td>               
            </tr>
            </c:forEach>
...
<script type="text/javascript">
 ...
 
                    {
                           ...
                           //alert(document.getElementById("cb").checked);
 
                           if (document.getElementById("cb").checked){
 
                                 document.getElementById("ord_name").value =  document.getElementById("d_mb_name").innerText;
 
                                 document.getElementById("ord_tel").value =   document.getElementById("d_mb_phone").value; 
                           }
  ...
  $(document).ready(function() {
    ...
    $("button[name='btn_buy']").on("click", function() {
      ...
      let pay_type = $("select[name='pay_method']").find("option:selected").val();
      ...
      let order_info = {
        ...
        ord_deaddr : $("input[name='ord_deaddr']").val(),
        ord_tel : $("#ord_tel").val(), 
